  ...
  return (
    <div className="min-h-screen bg-white pt-16">
      <div className="max-w-4xl mx-auto px-4 py-24">
        <h1 className="text-5xl font-serif font-light mb-8">Privacy Policy</h1>
        <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">1. Introduction</h2>
            <p>
              Nobies Lens ("we," "us," "our," or "Company") is committed to protecting your privacy. This Privacy Policy
          ...
          <section>
            ...
            <p>
              Email: info@nobieslens.com
              <br />
              Phone: +212 706 633 200
              <br />
              Address: 123 Photography Lane, Creative District, Morocco
            </p>
          </section>
        </div>
      </div>
